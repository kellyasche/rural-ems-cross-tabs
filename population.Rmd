...
* Characteristics section
  + Is your agency owned, managed or receive support from a corporate health system?
...
* *Receives corp health system support: * although only 27% of agencies responded that they are owned, managed or receive support from a corporate health system, agencies that serve larger populations were significantly more likely to respond this way - 42% of responses serving 10,000 - 14,999 and 77% of responses serving 15,000 people or more.
...
* *Management challenge areas - recruitment: * Although a majority of agencies (69%) responded that recruitment was a management challenge area, agencies that serve low to moderate sized populations responded this way at a significantly higher rate - 72% of responses serving less than 2,500, 84% of responses serving 2,500 - 4,999 and 77% of responses serving 5,000 - 9,999.
* *Management challenge areas - retention: *e Although only 43% of all agencies responded that retention was a management challenge area, agencies serving moderate sized populations were significantly more likely to respond this way - 51% of responses serving 2,500 - 4,999 and 60% of responses serving 5,000 - 9,999.
* *Management challenge areas - staffing the schedule: * Although just over half of all agencies (51%) responded that staffing the schedule was a management challenge area, agencies that serve moderate size populations were significantly more likely to respond this way - 61% of responses serving 2,500 - 4,999 and 70% of responses serving 5,000 - 9,999. 
* *Management challenge areas - none: * Although only 9% of all agencies responded that there were "none" management challenge areas, agencies that serve larger populations were significantly more likely to respond this way - 17% of responses serving 10,000 - 14,999 and 27% of responses serving greater than 15,000.
...
This question provided 2 choices which are provided below in order of the top one receiving the most responses;

* No (72%)
* Yes (27%)

There is a relationship between the size of the population served by an agency and whether they are owned, managed or receive support from a corporate health system.

As the population served by an agency increases so does the likelihood that it is owned, managed, or receives support from a corporate health system.

* Less than 2,500: 6 responses (13%) vs. 12 expected (27%)
* 2,500 - 4,999: 7 responses (12%) vs. 15 expected (27%)
* 5,000 - 9,999: 5 responses (17%) vs. 8 expected (27%)
* 10,000 - 14,999: 10 responses (42%) vs. 6 expected (27%)
* Greater than 15,000: 20 responses (77%) vs. 7 expected (27%)

```{r pop served and corp support}
pop.corp.support <- master.responses %>%
  select(3,9) 

CrossTable(pop.corp.support$pop, pop.corp.support$corp.sup, expected = TRUE, prop.t = FALSE, prop.c = FALSE, prop.chisq = FALSE, max.width = 2)
...
There are two population size groups that are leading this p-value. The agencies that served populations 5,000 - 9,999 (significantly more likely to respond this as an obstacle) and greater than 15,000 (significantly less likely to respond this as an obstacle).
